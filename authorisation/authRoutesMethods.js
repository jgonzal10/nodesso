...
function registerUser(req, res){
    ...
    userDBHelper.doesUserExist(req.body.txSSOLoginName, (sqlError, doesUserExist) => {
      ...
      userDBHelper.registerUserInDB(req.body.txSSOLoginName, req.body.txSSOPassword, dataResponseObject => {
  ...
  function getUsers(req, res){
    ...
    //console.log(`res`, res);
    //console.log(`agetUsers`, req.body);

    //query db to see if the user exists already
    userDBHelper.getUserS(req,res)
  }
